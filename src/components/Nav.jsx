        ...
        <nav className="bg-gray-800 text-white py-3 px-4 flex items-center justify-between relative">
            ...
            <div className="hidden md:flex items-center space-x-4">
                <button
                    ...
                    className="relative flex items-center py-2 px-4 bg-gray-700 text-white font-bold rounded-md transition duration-200 hover:bg-gray-600 hover:text-yellow-400"
                >
            ...
            {menuOpen && (
                <div className="absolute top-16 left-0 w-full bg-gray-800 z-10 p-4 space-y-4 md:hidden">
                    <button
                        onClick={() => changeLanguage("en")}
                        className="block w-full py-2 px-4 bg-gray-700 text-white font-bold rounded-md transition duration-200 hover:bg-gray-600 hover:text-yellow-400"
                    >
                        <span className="absolute top-0 left-0 mt-1 ml-1 h-full w-full rounded bg-gray-900"></span>
                        <span className="relative" style={{ top: '2px', left: '2px' }}>English</span>
                    </button>
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="relative flex items-center justify-center" style={{ top: '2px', left: '2px' }}>
                                    Delete User <TrashIcon width={20} className="ml-2" />
                                </span>
                            </button>
                        </Form>
                    )}
